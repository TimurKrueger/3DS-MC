...
int main() {
    ...
    //visualizer.vie.plugins.push_back(&plugin);
    //plugin.widgets.push_back(&menu);

    //menu.callback_draw_viewer_menu = [&]()
    //{
    //    std::cout << "IMGUI START" << menu.name << std::endl;
    ...
    //        ImGui::InputFloat("float", &f, 0, 0, "%.3f");
    ...
    //    ImGui::DragScalar("double", ImGuiDataType_Double, &d, 0.1, 0, 0, "%.4f");
    //    ImGui::PopItemWidth();
...
//    igl::readOFF("../Data/Cactus/cactus_small.off", V, F);
//
//    // Init the viewer
